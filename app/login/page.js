...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-sky-100 via-blue-50 to-cyan-100 px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto flex min-h-[calc(100vh-5rem)] w-full max-w-md items-center">
        <div className="w-full rounded-3xl border border-white/70 bg-white/90 p-7 shadow-[0_18px_45px_rgba(50,90,150,0.15)] backdrop-blur-sm sm:p-9">
          <div className="mb-8 text-center">
            <h1 className="font-sans text-3xl font-semibold tracking-tight text-slate-900">Login</h1>
